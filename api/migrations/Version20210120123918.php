...
final class Version20210120123918 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE subject ADD archived BOOLEAN DEFAULT \'false\' NOT NULL');
        $this->addSql('ALTER TABLE subject DROP archived_at');
        $this->addSql('ALTER TABLE "user" ALTER lastname SET DEFAULT \'Smith\'');
    }
}
